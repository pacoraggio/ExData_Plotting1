...
temp <- tempfile()
download.file(data_link,temp, method = "curl")
...
# Producing and saving the png file
png("plot4.png", width = 480, height = 480, units = "px")
par(mfrow = c(2,2))
plot(k, df1$Global_active_power, ylab = "Global Active Power", xlab = "", type = 'l')
plot(k,df1$Voltage, xlab = "datetime", ylab = "Voltage", type="l")
...
plot(k, df1$Global_reactive_power, xlab = "datetime", ylab = "Global_reactive_power", type = "l")
dev.off()
